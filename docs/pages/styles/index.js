...
export default function Styles() {
  return (
    ...
    * className className prop specified for custom components will also be composed into the selector string produced by the cx functions

    ### getStyles
    Each component gets passed a getStyles method which has the following signature:

    ~~~
    (key, props: Object) => stylesObject;
    ~~~
